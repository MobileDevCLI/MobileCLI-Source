...
public final class TerminalColorScheme {
    ...
    public void updateWith(Properties props) throws NumberFormatException {
        int colorIndex;
        reset();
        for (Map.Entry<Object, Object> entries : props.entrySet()) {
            ...
            } else if (key.startsWith(TypedValues.Custom.S_COLOR)) {
                try {
            ...
            this.mDefaultColors[colorIndex] = colorValue;
        }
    }
}
